# Dockerfile: YOLOv8 + OpenImages (güncel repo) ortamı
...
# OpenImages ToolKit için bağımlılıkları yükle
RUN pip3 install -r /workspace/OIDv6_ToolKit/requirements.txt
